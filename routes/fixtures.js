...
router.post('/fixtures', protect, multer.fields([{ name: 'homeLogo' }, { name: 'awayLogo' }]), postFixtures);
router.put('/fixtures/:id', protect, multer.fields([{ name: 'homeLogo' }, { name: 'awayLogo' }]), updateFixtures);
